    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                ...
                @endphp
                @if(count($segments) == 0)
                    <li class="active"><i class="facilitador-boat"></i> {{ __('support::generic.dashboard') }}</li>
                @else
                    <li class="active">
        ...
        <ul class="nav navbar-nav @if (__('support::generic.is_rtl') == 'true') navbar-left @else navbar-right @endif">
