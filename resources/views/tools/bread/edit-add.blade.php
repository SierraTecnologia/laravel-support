...
@if (isset($dataType->id))
    @section('page_title', __('pedreiro::bread.edit_bread_for_table', ['table' => $dataType->name]))
    @php
    ...
    @endphp
@else
    @section('page_title', __('pedreiro::bread.create_bread_for_table', ['table' => $table]))
@endif
...
@section('page_header')
    <div class="page-title">
        ...
        @if (isset($dataType->id))
            {{ __('pedreiro::bread.edit_bread_for_table', ['table' => $dataType->name]) }}
        @else
            {{ __('pedreiro::bread.create_bread_for_table', ['table' => $table]) }}
        @endif
    </div>
    @php
    ...
    @endphp
    @include('support::multilingual.language-selector')
@stop

@section('breadcrumbs')
<ol class="breadcrumb hidden-xs">
    <li class="active">
        <a href="{{ route('rica.dashboard')}}"><i class="facilitador-boat"></i> {{ __('voyager::generic.dashboard') }}</a>
    </li>
    <li class="active">
...
@section('content')
    <div class="page-content container-fluid" id="facilitadorBreadEditAdd">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="facilitador-bread"></i> {{ ucfirst($table) }} {{ __('pedreiro::bread.bread_info') }}</h3>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="display_name_singular">{{ __('pedreiro::bread.display_name_singular') }}</label>
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('pedreiro::bread.display_name_singular') }}"
                                           value="{{ $display_name }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="display_name_plural">{{ __('pedreiro::bread.display_name_plural') }}</label>
                                    @if($isModelTranslatable)
                                        @include('support::multilingual.input-hidden', [
                                            'isModelTranslatable' => true,
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('pedreiro::bread.display_name_plural') }}"
                                           value="{{ $display_name_plural }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="slug">{{ __('pedreiro::bread.url_slug') }}</label>
                                    <input type="text" class="form-control" name="slug" placeholder="{{ __('pedreiro::bread.url_slug_ph') }}"
                                           value="{{ $dataType->slug ?? $slug }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="icon">{{ __('pedreiro::bread.icon_hint') }} <a
                                                href="{{ route('facilitador.compass.index', [], false) }}#fonts"
                                                target="_blank">{{ __('pedreiro::bread.icon_hint2') }}</a></label>
                                    <input type="text" class="form-control" name="icon"
                                           placeholder="{{ __('pedreiro::bread.icon_class') }}"
                                           value="{{ $dataType->icon ?? '' }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="model_name">{{ __('pedreiro::bread.model_name') }}</label>
                                    <span class="facilitador-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('pedreiro::bread.model_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="model_name" placeholder="{{ __('pedreiro::bread.model_class') }}"
                                           value="{{ $dataType->model_name ?? $model_name }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="controller">{{ __('pedreiro::bread.controller_name') }}</label>
                                    <span class="facilitador-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('pedreiro::bread.controller_name_hint') }}"></span>
                                    <input type="text" class="form-control" name="controller" placeholder="{{ __('pedreiro::bread.controller_name') }}"
                                           value="{{ $dataType->controller ?? '' }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="policy_name">{{ __('pedreiro::bread.policy_name') }}</label>
                                    <span class="facilitador-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('pedreiro::bread.policy_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="policy_name" placeholder="{{ __('pedreiro::bread.policy_class') }}"
                                           value="{{ $dataType->policy_name ?? '' }}">
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="generate_permissions">{{ __('pedreiro::bread.generate_permissions') }}</label><br>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="server_side">{{ __('pedreiro::bread.server_pagination') }}</label><br>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-3 form-group">
                                    <label for="order_column">{{ __('pedreiro::bread.order_column') }}</label>
                                    <span class="facilitador-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('pedreiro::bread.order_column_ph') }}"></span>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="order_display_column">{{ __('pedreiro::bread.order_ident_column') }}</label>
                                    <span class="facilitador-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('pedreiro::bread.order_ident_column_ph') }}"></span>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="order_direction">{{ __('pedreiro::bread.order_direction') }}</label>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="default_search_key">{{ __('pedreiro::bread.default_search_key') }}</label>
                                    <span class="facilitador-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('pedreiro::bread.default_search_key_ph') }}"></span>
                            ...
                            <div class="row clearfix">
                                @if (isset($scopes) && isset($dataType))
                                    <div class="col-md-3 form-group">
                                        <label for="scope">{{ __('pedreiro::bread.scope') }}</label>
                                ...
                                <div class="col-md-9 form-group">
                                    <label for="description">{{ __('pedreiro::bread.description') }}</label>
                                    <textarea class="form-control"
                                              name="description"
                                              placeholder="{{ __('pedreiro::bread.description') }}"
                    ...
                    <div class="panel panel-primary panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="facilitador-window-list"></i> {{ __('pedreiro::bread.edit_rows', ['table' => $table]) }}:</h3>
                            <div class="panel-actions">
                                <a class="panel-action facilitador-angle-up" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row fake-table-hd">
                                ...
                                <div class="col-xs-2">{{ __('pedreiro::bread.display_name') }}</div>
                            ...
                            @foreach($fieldOptions as $data)
                                ...
                                @if(isset($dataType->id))
                                    <?php $dataRow = Support::model('DataRow')->where('data_type_id', '=', $dataType->id)->where('field', '=', $data['field'])->first(); ?>
                                @endif
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        @else
                                            <select name="field_input_type_{{ $data['field'] }}">
                                                @foreach (Support::formFields() as $formField)
                                                    @php
                                    ...
                                    <div class="col-xs-2">
                                        @if($isModelTranslatable)
                                            @include('support::multilingual.input-hidden', [
                                                ...
                                                '_field_trans' => $dataRow ? get_field_translations($dataRow, 'display_name') : json_encode([config('sitec.facilitador.multilingual.default') => ucwords(str_replace('_', ' ', $data['field']))]),
                                            ])
                                        @endif
                                        <input type="text" class="form-control"
                            ...
                            @if(isset($dataTypeRelationships))
                                @foreach($dataTypeRelationships as $relationship)
                                    @include('support::tools.bread.relationship-partial', $relationship)
                                @endforeach
                            @endif
...
@include('support::tools.bread.relationship-new-modal')
...
@section('javascript')
    ...
    <script>
       ...
       $(function () {
            ...
            $('.facilitador-relationship-details-btn').click(function(){
                $(this).toggleClass('open');
                if($(this).hasClass('open')){
                    $(this).parent().parent().find('.facilitador-relationship-details').slideDown();
                    populateRowsFromTable($(this).parent().parent().find('select.relationship_table'));
                } else {
                    $(this).parent().parent().find('.facilitador-relationship-details').slideUp();
                }
            });
