...
@if (isset($dataType->id))
    ...
    @endphp
@else
    @section('page_title', __('facilitador::cruds.bread.create_bread_for_table', ['table' => $table]))
@endif
...
@section('page_header')
    <div class="page-title">
        ...
        @if (isset($dataType->id))
            {{ __('facilitador::cruds.bread.edit_bread_for_table', ['table' => $dataType->name]) }}
        @else
            {{ __('facilitador::cruds.bread.create_bread_for_table', ['table' => $table]) }}
        @endif
    </div>
    @php
                ...
                @endif
                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="facilitador-bread"></i> {{ ucfirst($table) }} {{ __('facilitador::cruds.bread.bread_info') }}</h3>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('facilitador::cruds.bread.display_name_singular') }}"
                                           value="{{ $display_name }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('facilitador::cruds.bread.display_name_plural') }}"
                                           value="{{ $display_name_plural }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="slug">{{ __('facilitador::cruds.bread.url_slug') }}</label>
                                    <input type="text" class="form-control" name="slug" placeholder="{{ __('facilitador::cruds.bread.url_slug_ph') }}"
                                           value="{{ $dataType->slug ?? $slug }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="icon">{{ __('facilitador::cruds.bread.icon_hint') }} <a
                                                href="{{ route('facilitador.compass.index', [], false) }}#fonts"
                                                target="_blank">{{ __('facilitador::cruds.bread.icon_hint2') }}</a></label>
                                    <input type="text" class="form-control" name="icon"
                                           placeholder="{{ __('facilitador::cruds.bread.icon_class') }}"
                                           value="{{ $dataType->icon ?? '' }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="model_name">{{ __('facilitador::cruds.bread.model_name') }}</label>
                                    <span class="facilitador-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('facilitador::cruds.bread.model_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="model_name" placeholder="{{ __('facilitador::cruds.bread.model_class') }}"
                                           value="{{ $dataType->model_name ?? $model_name }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="controller">{{ __('facilitador::cruds.bread.controller_name') }}</label>
                                    <span class="facilitador-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('facilitador::cruds.bread.controller_name_hint') }}"></span>
                                    <input type="text" class="form-control" name="controller" placeholder="{{ __('facilitador::cruds.bread.controller_name') }}"
                                           value="{{ $dataType->controller ?? '' }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="policy_name">{{ __('facilitador::cruds.bread.policy_name') }}</label>
                                    <span class="facilitador-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('facilitador::cruds.bread.policy_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="policy_name" placeholder="{{ __('facilitador::cruds.bread.policy_class') }}"
                                           value="{{ $dataType->policy_name ?? '' }}">
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="generate_permissions">{{ __('facilitador::cruds.bread.generate_permissions') }}</label><br>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="server_side">{{ __('facilitador::cruds.bread.server_pagination') }}</label><br>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-3 form-group">
                                    <label for="order_column">{{ __('facilitador::cruds.bread.order_column') }}</label>
                                    <span class="facilitador-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('facilitador::cruds.bread.order_column_ph') }}"></span>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="order_display_column">{{ __('facilitador::cruds.bread.order_ident_column') }}</label>
                                    <span class="facilitador-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('facilitador::cruds.bread.order_ident_column_ph') }}"></span>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="order_direction">{{ __('facilitador::cruds.bread.order_direction') }}</label>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="default_search_key">{{ __('facilitador::cruds.bread.default_search_key') }}</label>
                                    <span class="facilitador-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('facilitador::cruds.bread.default_search_key_ph') }}"></span>
                            ...
                            <div class="row clearfix">
                                @if (isset($scopes) && isset($dataType))
                                    <div class="col-md-3 form-group">
                                        <label for="scope">{{ __('facilitador::cruds.bread.scope') }}</label>
                                ...
                                <div class="col-md-9 form-group">
                                    <label for="description">{{ __('facilitador::cruds.bread.description') }}</label>
                                    <textarea class="form-control"
                                              name="description"
                                              placeholder="{{ __('facilitador::cruds.bread.description') }}"
                    ...
                    <div class="panel panel-primary panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="facilitador-window-list"></i> {{ __('facilitador::cruds.bread.edit_rows', ['table' => $table]) }}:</h3>
                            <div class="panel-actions">
                                <a class="panel-action facilitador-angle-up" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row fake-table-hd">
                                ...
                                <div class="col-xs-2">{{ __('facilitador::cruds.bread.display_name') }}</div>
