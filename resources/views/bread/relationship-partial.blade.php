...
<div class="row row-dd row-dd-relationship">
    ...
    <div class="col-md-12 facilitador-relationship-details">
        <a href="{{ route('facilitador.bread.delete_relationship', $relationship['id']) }}" class="delete_relationship"><i class="facilitador-trash"></i> {{ __('facilitador::database.relationship.delete') }}</a>
