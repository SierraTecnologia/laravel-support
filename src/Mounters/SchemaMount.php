    ...
    public function render()
    {
        ...
        foreach ($models as $model) {
            try {
                ...
                $tableName = ParseModelClass::getTableName($model);
                $hardParserModelClass = new ParseModelClass($model);
                
                // $inflector = new \Doctrine\Inflector\Inflector(new \Doctrine\Inflector\NoopWordInflector(), new \Doctrine\Inflector\NoopWordInflector());
                
                // $singular = $inflector->singularize($tableName);
        
                dd($model, $tableName, $hardParserModelClass->toArray());
