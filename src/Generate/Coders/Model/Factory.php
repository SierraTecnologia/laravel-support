...
namespace Support\Generate\Coders\Model;

use Illuminate\Support\Str;
use Support\Generate\Meta\Blueprint;
use Support\Generate\Support\Classify;
use Support\Generate\Meta\SchemaManager;
...
class Factory
{
    ...
    /**
     * @var \Support\Generate\Meta\SchemaManager
     */
    protected $schemas = [];
    ...
    /**
     * @var \Support\Generate\Support\Classify
     */
    protected $class;

    /**
     * @var \Support\Generate\Coders\Model\Config
     */
    protected $config;

    /**
     * @var \Support\Generate\Coders\Model\ModelManager
     */
    protected $models;

    /**
     * @var \Support\Generate\Coders\Model\Mutator[]
     */
    protected $mutators = [];
     ...
     * @param \Support\Generate\Support\Classify $writer
     * @param \Support\Generate\Coders\Model\Config $config
     */
    ...
    /**
     * @return \Support\Generate\Coders\Model\Mutator
     */
    ...
    /**
     * @return \Support\Generate\Coders\Model\ModelManager
     */
    ...
    /**
     * @param \Support\Generate\Meta\Blueprint $blueprint
     *
     * @return bool
     */
     ...
     *
     * @return \Support\Generate\Coders\Model\Model
     */
     ...
     * @param string $schema
     *
     * @return \Support\Generate\Meta\Schema
     */
    ...
    /**
     * @param \Support\Generate\Coders\Model\Model $model
     *
    ...
    /**
     * @param \Support\Generate\Meta\Blueprint|null $blueprint
     * @param string $key
     * @param mixed $default
     *
     * @return mixed|\Support\Generate\Coders\Model\Config
     */
