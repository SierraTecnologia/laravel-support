...
namespace Support\Discovers\Reliese\Coders\Model;

use Illuminate\Support\Str;
use Support\Discovers\Reliese\Meta\Blueprint;
use Support\Discovers\Reliese\Support\Classify;
use Support\Discovers\Reliese\Meta\SchemaManager;
...
class Factory
{
    ...
    /**
     * @var \Support\Discovers\Reliese\Meta\SchemaManager
     */
    protected $schemas = [];
    ...
    /**
     * @var \Support\Discovers\Reliese\Support\Classify
     */
    protected $class;

    /**
     * @var \Support\Discovers\Reliese\Coders\Model\Config
     */
    protected $config;

    /**
     * @var \Support\Discovers\Reliese\Coders\Model\ModelManager
     */
    protected $models;

    /**
     * @var \Support\Discovers\Reliese\Coders\Model\Mutator[]
     */
    protected $mutators = [];
     ...
     * @param \Support\Discovers\Reliese\Support\Classify $writer
     * @param \Support\Discovers\Reliese\Coders\Model\Config $config
     */
    ...
    /**
     * @return \Support\Discovers\Reliese\Coders\Model\Mutator
     */
    ...
    /**
     * @return \Support\Discovers\Reliese\Coders\Model\ModelManager
     */
    ...
    /**
     * @param \Support\Discovers\Reliese\Meta\Blueprint $blueprint
     *
     * @return bool
     */
     ...
     *
     * @return \Support\Discovers\Reliese\Coders\Model\Model
     */
     ...
     * @param string $schema
     *
     * @return \Support\Discovers\Reliese\Meta\Schema
     */
    ...
    /**
     * @param \Support\Discovers\Reliese\Coders\Model\Model $model
     *
    ...
    /**
     * @param \Support\Discovers\Reliese\Meta\Blueprint|null $blueprint
     * @param string $key
     * @param mixed $default
     *
     * @return mixed|\Support\Discovers\Reliese\Coders\Model\Config
     */
