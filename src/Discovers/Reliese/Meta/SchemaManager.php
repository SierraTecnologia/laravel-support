...
namespace Support\Discovers\Reliese\Meta;
...
use Support\Discovers\Reliese\Meta\MySql\Schema as MySqlSchema;
use Support\Discovers\Reliese\Meta\Sqlite\Schema as SqliteSchema;
...
class SchemaManager implements IteratorAggregate
{
    ...
    /**
     * @var \Support\Discovers\Reliese\Meta\Schema[]
     */
    protected $schemas = [];
