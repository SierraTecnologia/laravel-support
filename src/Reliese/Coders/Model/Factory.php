...
use Support\Reliese\Support\Classify;
use Support\Reliese\Meta\SchemaManager;
...
class Factory
{
    ...
    /**
     * @var \Support\Reliese\Meta\SchemaManager
     */
    protected $schemas = [];
    ...
    /**
     * @var \Support\Reliese\Support\Classify
     */
    protected $class;

    /**
     * @var \Support\Reliese\Coders\Model\Config
     */
    protected $config;

    /**
     * @var \Support\Reliese\Coders\Model\ModelManager
     */
    protected $models;

    /**
     * @var \Support\Reliese\Coders\Model\Mutator[]
     */
    protected $mutators = [];
     ...
     * @param \Support\Reliese\Support\Classify $writer
     * @param \Support\Reliese\Coders\Model\Config $config
     */
    ...
    /**
     * @return \Support\Reliese\Coders\Model\Mutator
     */
    ...
    /**
     * @return \Support\Reliese\Coders\Model\ModelManager
     */
    ...
    /**
     * @param \Support\Reliese\Meta\Blueprint $blueprint
     *
     * @return bool
     */
     ...
     * @param string $schema
     *
     * @return \Support\Reliese\Meta\Schema
     */
    ...
    /**
     * @param \Support\Reliese\Coders\Model\Model $model
     *
    ...
    /**
     * @param \Support\Reliese\Meta\Blueprint|null $blueprint
     * @param string $key
     * @param mixed $default
     *
     * @return mixed|\Support\Reliese\Coders\Model\Config
     */
