...
\t{
\t\treturn \$this->hasOne('Locaravel\\{$camel_field}', '{$field->REFERENCED_COLUMN_NAME}', '{$field->COLUMN_NAME}');
\t}\n\n";
        }
...
\t{
\t\treturn \$this->hasMany('Locaravel\\{$this->camelCase1($field->TABLE_NAME)}', '{$field->COLUMN_NAME}', '{$field->REFERENCED_COLUMN_NAME}');
\t}\n\n";
        }
