...
namespace Support\Coder\Generate\Coders\Model;

use Illuminate\Support\Str;
use Support\Coder\Generate\Meta\Blueprint;
use Support\Coder\Generate\Support\Classify;
use Support\Coder\Generate\Meta\SchemaManager;
...
class Factory
{
    ...
    /**
     * @var \Support\Coder\Generate\Meta\SchemaManager
     */
    protected $schemas = [];
    ...
    /**
     * @var \Support\Coder\Generate\Support\Classify
     */
    protected $class;

    /**
     * @var \Support\Coder\Generate\Coders\Model\Config
     */
    protected $config;

    /**
     * @var \Support\Coder\Generate\Coders\Model\ModelManager
     */
    protected $models;

    /**
     * @var \Support\Coder\Generate\Coders\Model\Mutator[]
     */
    protected $mutators = [];
     ...
     * @param \Support\Coder\Generate\Support\Classify $writer
     * @param \Support\Coder\Generate\Coders\Model\Config $config
     */
    ...
    /**
     * @return \Support\Coder\Generate\Coders\Model\Mutator
     */
    ...
    /**
     * @return \Support\Coder\Generate\Coders\Model\ModelManager
     */
    ...
    /**
     * @param \Support\Coder\Generate\Meta\Blueprint $blueprint
     *
     * @return bool
     */
     ...
     *
     * @return \Support\Coder\Generate\Coders\Model\Model
     */
     ...
     * @param string $schema
     *
     * @return \Support\Coder\Generate\Meta\Schema
     */
    ...
    /**
     * @param \Support\Coder\Generate\Coders\Model\Model $model
     *
    ...
    /**
     * @param \Support\Coder\Generate\Meta\Blueprint|null $blueprint
     * @param string $key
     * @param mixed $default
     *
     * @return mixed|\Support\Coder\Generate\Coders\Model\Config
     */
