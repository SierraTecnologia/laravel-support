...
use Support\Coder\Generate\Meta\MySql\Schema as MySqlSchema;
use Support\Coder\Generate\Meta\Sqlite\Schema as SqliteSchema;
...
class SchemaManager implements IteratorAggregate
{
    ...
    /**
     * @var \Support\Coder\Generate\Meta\Schema[]
     */
    protected $schemas = [];
