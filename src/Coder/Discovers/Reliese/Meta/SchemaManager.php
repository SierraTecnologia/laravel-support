...
namespace Support\Coder\Discovers\Reliese\Meta;
...
use Support\Coder\Discovers\Reliese\Meta\MySql\Schema as MySqlSchema;
use Support\Coder\Discovers\Reliese\Meta\Sqlite\Schema as SqliteSchema;
...
class SchemaManager implements IteratorAggregate
{
    ...
    /**
     * @var \Support\Coder\Discovers\Reliese\Meta\Schema[]
     */
    protected $schemas = [];
