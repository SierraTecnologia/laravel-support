 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder|\Support\Elements\Entities\Type\Integer whereAttributeId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Support\Elements\Entities\Type\Integer whereContent($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Support\Elements\Entities\Type\Integer whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Support\Elements\Entities\Type\Integer whereEntityId($value)
...
class Integer extends Value
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('sitec.attributes.tables.attribute_integer_values'));
        $this->setRules([
