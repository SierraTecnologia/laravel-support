<?php
/**
 * Arquivo de configurações para gerar código
 */
    ...
    */
    ...
    '*' => [
        ...
        */
        ...
        'use' => [
            // Support\Components\Database\Eloquent\BitBooleans::class,
            // Support\Components\Database\Eloquent\BlamableBehavior::class,
        ],
